 ...
 *
 */
class Fragment_widget : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_fragment_widget , container, false)
    }
    ...
    class WidgetActivity : VectorAppCompatActivity() {
        ...
        override fun getLayoutRes() = R.layout.fragment_fragment_widget
        ...
        companion object {
            private val LOG_TAG = im.vector.activity.WidgetActivity::class.java.simpleName
            ...
            fun getIntent(context: Context, widget: Widget): Intent {
                return Intent(context, im.vector.activity.WidgetActivity::class.java)
                        .apply {
